...
class main_window():
    ...
    def main_page(self):
        ...
        self.label11= tk.Button(self.frame_view2,text="destroy2")
        ...
        self.frame_view3.pack(ipadx=550,ipady=100,side='top',fill='y')
    ...
    def destroy_frame_view3(self):
             ...
             self.frames_status()
             self.frame_view4.pack(ipadx=670,ipady=250,side='top')
